...
public static function getInt()
{
    ...
    while(!is_numeric($integer)||$integer/(int)$integer>1)//validating whether it of int and if it is decimal and converting in to int and checking the condition the int value >1
    {
